...
namespace IntelligentAgents
{
    public class Program
    {
        ...
        static void Main() {
            ...
            Console.WriteLine("! All the data are located to the Logs director !");
            Console.WriteLine("");
        ...
        private static void checkResults(String result, String villageName)
        {
            ...
            }else if (result.Equals(Constants.VILLAGE_WIN))
            {
                ...
                s.AppendLine(DateTime.Now.ToString("dddd, dd MMMM yyyy") + ": " + villageName + " win");
                
                ConsoleMessages.saveDataToFile("Results", s);
                return;
            }else if (result.Equals(Constants.AGIENTS_DIED))
            {
                Console.WriteLine("Village " + villageName + " loose, all the agients Died");
                StringBuilder s = new StringBuilder();
                s.AppendLine(DateTime.Now.ToString("dddd, dd MMMM yyyy") + ": " + villageName + " loose, all the agients Died");
